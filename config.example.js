module.exports = {
   ...
   imapKeepalive: {
      interval: 60 * 1000, // This is the interval (in ms) at which NOOPs are sent and the interval at which idleInterval is checked Default: 10000
      idleInterval: 5 * 60 * 1000, // This is the interval (in ms) at which an IDLE command (for servers that support IDLE) is re-sent. Default: 300000 (5 mins)
